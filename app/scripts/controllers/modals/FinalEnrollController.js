...
define(['paw', 'services/modalFactory', 'services/Students', 'services/flashMessages'], function(paw) {
  paw.controller('FinalEnrollController',
    ...
    function (modalFactory, $log, Students, $route, flashMessages) {
      ...
      var onSuccess = function(result) {
        Students.finalEnroll(result.docket, result.id)
      ...
      this.open = function (size, title, docket, fullName, courseName, finalExamDate, id) {
        ...
        modalFactory.create(size, 'FinalEnrollModalInstanceController', modalTemplateUrl, resolve, onSuccess, onFailure);
      };
    }]);

    paw.controller('FinalEnrollModalInstanceController',
    function($uibModalInstance, title, docket, fullName, courseName, finalExamDate, id) {
      ...
      this.cancel = function () {
        $uibModalInstance.dismiss('Final inscription enroll modal dismissed at: ' + new Date());
      };
    });
