...
<head>
    <title>
        <spring:message code="webAbbreviation"/> | <spring:message code="addAdmin"/>
    </title>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <spring:message code="admins"/> <small> - <spring:message code="add"/></small>
                    </h1>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <form:form modelAttribute="adminForm" method="post" action="/admin/add_admin">
                    <!-- User Data -->
